...
- `category` = 34133-9 (EHDS priority category, LOINC Document Class, for coarse filtering)
...
// Category: EHDS priority category (LOINC Document Class, coarse search)
* category = $loinc#34133-9 "Summary of episode note"
