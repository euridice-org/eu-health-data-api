...
// DocumentReference search parameters - SHALL support, mirroring the EEHRxF Document
// Access Provider / MHD Document Responder (this grouped actor's external query side).
