{% assign XtEHR             = "[XtEHR](https://www.xt-ehr.eu/)" %}
...
{% assign SMARTonFHIR       = "[FHIR SMART App Launch](https://hl7.org/fhir/smart-app-launch/app-launch.html)" %}
{% assign SMARTbackend      = "[SMART Backend Services](https://hl7.org/fhir/smart-app-launch/backend-services.html)" %}
{% assign R-code            = "R4" %}
