...
| `api-provider-patient` | The EHR system Interoperability Software Component SHOULD offer a patient lookup API. | Annex II §2.1 | Access Provider | [Patient Demographics Supplier](patient-match.html) | PDQm ITI-78 |
