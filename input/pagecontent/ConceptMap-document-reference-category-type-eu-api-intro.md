...
- `Patient-Summaries` codes are found in [DocumentTypePatientSummaryEuApiVS](ValueSet-document-type-patient-summary-eu-api.html)
- `Discharge-Reports` codes are found in [DocumentTypeDischargeReportEuApiVS](ValueSet-document-type-discharge-report-eu-api.html)
- `Laboratory-Reports` codes are found in [DocumentTypeLaboratoryReportEuApiVS](ValueSet-document-type-laboratory-report-eu-api.html)
- `Medical-Imaging` codes are found in [DocumentTypeMedicalImagingEuApiVS](ValueSet-document-type-medical-imaging-eu-api.html)
