...
This version of the IG defines resource access (search and read) only. How resources reach the Resource Access Provider — and any resource production or write role — is out of scope for v1. See [Resource Exchange](resourceExchange.html) for approaches and possible future work.
