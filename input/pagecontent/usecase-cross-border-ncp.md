...
This IG defines the EHR interoperability component API surface used at the **final step** — how national infrastructure (or the NCP itself) queries EHR systems for the patient's data.
...
- **NCP or national infrastructure** — acts as [Document Consumer](actors.html#document-consumer) and/or [Resource Consumer](actors.html#resource-consumer) of the EHR interoperability component API surface
...
Cross-border patient consent, health-professional authentication in the requesting country, and authorization at the NCP and national-infrastructure layers are governed by MyHealth@EU and Member State infrastructure — not by this IG. At the EHR interoperability component API surface, the consumer is an authorized national-infrastructure component; how that authorization was established is out of scope here.
