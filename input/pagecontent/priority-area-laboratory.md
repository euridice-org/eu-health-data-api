...
|-------|-------------|---------------------|
| Document Consumer | Retrieves laboratory reports | [EEHRxF Document Consumer](CapabilityStatement-EehrxfDocumentConsumer.html) |
| Document Access Provider | Serves laboratory reports | [EEHRxF Document Access Provider](CapabilityStatement-EehrxfDocumentAccessProvider.html) |
